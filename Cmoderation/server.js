                                            ...
                                            message.channel.awaitMessages(messageFilter,{max: 1, time : 120000, errors: ['time']})
                                                .then(a => {    
                                                    ...
                                                    if(isNaN(parseInt(msg)) && msg.toLowerCase() !=="no")return message.channel.send("Invalid argument, command failed.");
                                                        ...
                                                        embed.setDescription(`${type0Message} **Type the id of your join and leave logging channel.**`);
                                                        m.edit(embed);
                                                        message.channel.awaitMessages(messageFilter,{max: 1, time : 120000, errors: ['time']})
                                                            .then(a => {    
                                                                let msg = a.first().content;
                                                                ...
                                                                if(isNaN(parseInt(msg)) && msg.toLowerCase() !=="no")return message.channel.send("Invalid argument, command failed.");
                                                                    ...
                                                                    daServer.hiByeLog = msg;

                                                                    if(msg.toLowerCase() === "no")daServer.hiByeLog = "";
                                                                    ...
                                                                    message.channel.awaitMessages(messageFilter,{max: 1, time : 120000, errors: ['time']})
                                                                        .then(a => {    
                                                                            ...
                                                                            if(isNaN(parseInt(msg)) && msg.toLowerCase() !=="no")return message.channel.send("Invalid argument, command failed.");
                                                                                ...
                                                                                daServer.deleteLog = msg;
                                                                                    
                                                                                if(msg.toLowerCase() === "no")daServer.deleteLog = "";
                                                                                ...
                                                                                message.channel.awaitMessages(messageFilter,{max: 1, time : 120000, errors: ['time']})
                                                                                    .then(a => {    
                                                                                        ...
                                                                                        if(isNaN(parseInt(msg)) && msg.toLowerCase() !=="no")return message.channel.send("Invalid argument, command failed.");
                                                                                            ...
                                                                                            daServer.serverLog = msg;
                                                                                            
                                                                                            if(msg.toLowerCase() === "no")daServer.serverLog = "";
                                                                                                


                                                                                            embed.setDescription(`${type0Message} **Type the id of your warning logging channel.**`);
                                                                                            m.edit(embed);
                                                                                            message.channel.awaitMessages(messageFilter,{max: 1, time : 120000, errors: ['time']})
                                                                                                .then(a => {    
                                                                                                    let msg = a.first().content;
                                                                                                    ...
                                                                                                    if(isNaN(parseInt(msg)) && msg.toLowerCase() !=="no")return message.channel.send("Invalid argument, command failed.");
                                                                                                        ...
                                                                                                        daServer.warningLog = msg;
                                                                                                           
                                                                                                            if(msg.toLowerCase() === "no")daServer.warningLog = "";
