...
let pointsbatchRemove = new Command("pointsbatch-remove");

pointsbatchRemove.set({
    
	aliases         : ["pb-remove","pb-","pointsbatch-","pointsbatch-remove","pbatch-remove", "pbatch-"],
	description     : "Removes points from members in the server in batch mode",
	usage           : "pointsbatch-remove <@user or id> <number> <reason> | <@user or id> <number> <reason> |...",
	cooldown        : 20,
	unique          : false,
	category        : "points",
	whiteList       : null,
...
pointsbatchRemove.execute = async function(message, args, server) { 
    try {
...
module.exports = pointsbatchRemove; 